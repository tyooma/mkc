...
const initState = {
  initiatives: [
    ...
    },
    {
      ...
      desc: `250 молодих архітекторів з Європи та поза її межами приїдуть до українського міста Славутич на 11 днів. Впродовж події учасники житимуть в будівлі закинутої поліклініки в центрі міста. 25 воркшопів, організованих студентами та молодими професіоналами, будуть досліджувати тему Poliklinika, що відсилає до поняття охорони здоров’я та його відношення до архітектури. Обрані в процесі відкритого відбору, воркшопи будуть варіюватися від проектування та будівництва до теоретичних досліджень та концептуального мистецтва.`,
      moreBtn: {
        title: 'More...',
        color: '#801713',
    ...
    },
    {
      ...
      desc: `Міжнародний фестиваль дитячої творчості, телебачення та преси залучає молодь до соціальної активності у суспільному, культурному та економічному житті. Розкриває особливості життєдіяльності молоді в сучасних умовах. Сприяє цілеспрямованій професійній підготовці до роботи в ЗМІ, поглибленню творчих і дружніх контактів між дітьми різних країн. Юні журналісти, телеоператори, фотокореспонденти, редактори та журналісти дитячих газет і теле- та радіопрограм змагаються у своїй майстерності розкриття актуальних тем.`,
      moreBtn: {
        title: 'More...',
        color: '#d71016',
    ...
    },
    {
      ...
      desc: `Міжнародний фестиваль для людей поважного віку «GOLDenFest» – щорічний культурно-мистецький захід. Місією фестивалю є підвищення якості життя людей поважного віку, адаптація осіб старше 50 років до сучасного суспільного життя; створення умов для їх спілкування та самореалізації, задоволення соціальних потреб, розвиток культурно-туристичного потенціалу міста Славутича та регіону.`,
      moreBtn: {
        title: 'More...',
        color: '#801713',
